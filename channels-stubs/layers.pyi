...
# Define channel layer message type inline
class ChannelLayerMessage(TypedDict, total=False):
    """Message sent through channel layers"""
...
class BaseChannelLayer:
    ...
    expiry: int
    capacity: int
    channel_capacity: ChannelCapacityDict
    ...
    def __init__(
        ...
        expiry: int = ...,
        capacity: int = ...,
        channel_capacity: ChannelCapacityDict | None = ...,
        **kwargs: Any,
    ) -> None: ...
    ...
    async def send(self, channel: str, message: ChannelLayerMessage) -> None: ...
    async def receive(self, channel: str) -> ChannelLayerMessage: ...
    async def new_channel(self) -> str: ...
    async def flush(self) -> None: ...
    async def group_add(self, group: str, channel: str) -> None: ...
    async def group_discard(self, group: str, channel: str) -> None: ...
    async def group_send(self, group: str, message: ChannelLayerMessage) -> None: ...
